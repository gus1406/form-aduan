...
$sql_get_laporan = mysqli_query( $koneksi, "SELECT * FROM laporan WHERE id_laporan='$aduan_id' " );
	...
	<div class="container">
		<div class="aduan-form-container">
			...
			<div class="aduan-form">
				...
				<form action="admin/admin-update-laporan.php" method="post" enctype="multipart/form-data">
